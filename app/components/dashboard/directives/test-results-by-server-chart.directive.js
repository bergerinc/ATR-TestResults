...
var TestResultsByServerChartDirective = (function () {
    function TestResultsByServerChartDirective(_elem, _zone, _testResultsSvc) {
        this._elem = _elem;
        this._zone = _zone;
    ...
    TestResultsByServerChartDirective.prototype.setUI = function (results) {
        var _this = this;
    ...
    TestResultsByServerChartDirective.prototype.getTestResults = function () {
        var _this = this;
        this._testResultsSvc.getTestResultsByServer().subscribe(function (res) {
            _this.setUI(res);
        });
    };
    TestResultsByServerChartDirective = __decorate([
        core_1.Directive({
    ...
    return TestResultsByServerChartDirective;
}());
exports.TestResultsByServerChartDirective = TestResultsByServerChartDirective;
//# sourceMappingURL=test-results-by-server-chart.directive.js.map