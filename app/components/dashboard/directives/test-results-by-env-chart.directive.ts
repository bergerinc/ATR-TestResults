...
import { EnvironmentTestResult } from '../../../models/environment-test-result';
...
export class TestResultsByEnvChartDirective {
    element: any;
    thisChart: any;
    results: EnvironmentTestResult[];
    ...
    setUI(results: EnvironmentTestResult[]) {
    ...
    getTestResults(){
        this._testResultsSvc.getTestResultsByEnvironment().subscribe(res => {
            this.setUI(res);
        });
    }
}